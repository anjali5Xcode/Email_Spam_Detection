...
Original file is located at
    https://colab.research.google.com/drive/12pE_i0Jkcl_1T5Ep4ZNo8Zh1nL8_NN4D
...
"""Model Testing on New Input Data"""
...
### Subtask:
Run the Streamlit application from your Colab notebook.

**Reasoning**:
Run the Streamlit application from the Colab notebook.
"""
...
*   The Streamlit library was successfully installed in the Colab environment.
*   A Python file named `app.py` was created to host the Streamlit application code.
*   The Streamlit application code was written to load a pre-trained machine learning model and vectorizer, accept email input, and predict spam/ham status.
*   The Streamlit application was successfully launched in the background from the Colab notebook.

### Insights or Next Steps

*   To access the running Streamlit app, a tunneling service like `ngrok` or `localtunnel` would be needed since Colab notebooks run on Google's servers.
*   Further development could involve improving the model's accuracy or adding features like displaying prediction probabilities.
